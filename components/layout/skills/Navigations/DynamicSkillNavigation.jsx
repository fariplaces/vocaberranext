...
import StaticSkillNavitaionMenu from "./StaticMenu";

const DynamicSkillNavigation = ({ sidebarOpen, sideMenu, baseRoute }) => {
  ...
  useEffect(() => {
    const allItems = [...StaticSkillNavitaionMenu, ...dynamicItems];
  ...
  // 3. Combine them
  const sidebarItems = [...StaticSkillNavitaionMenu, ...dynamicItems];
...
export default DynamicSkillNavigation;
